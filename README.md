...
```bash
git clone https://github.com/vinit-shenkeshi/AI_SOC.git
cd AI_SOC
./deploy-ai-soc.sh
```
...
@misc{aisoc2025,
  ...
  url          = {https://github.com/vinit-shenkeshi/AI_SOC}
}
```
...
Contact: vinitshenkeshi1@gmail.com

LinkedIn: https://www.linkedin.com/in/vinitshenkeshi/

## About the Developer

Vinit Shenkeshi is an AI/ML Engineer with over 4 years of experience building end-to-end machine learning and AI solutions. He specializes in developing scalable, production-ready ML systems using Python, PyTorch, and TensorFlow, with deep expertise in NLP, RAG, and LLM orchestration. Vinit maintains this implementation to bridge the gap between theoretical security research and practical, automated defense workflows.