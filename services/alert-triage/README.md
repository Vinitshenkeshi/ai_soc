...
This project is actively maintained by Vinit Shenkeshi. For inquiries or contributions, please reach out.
...
This project is actively maintained by Vinit Shenkeshi, an AI/ML Engineer with 4+ years of experience in building end-to-end machine learning and AI solutions. Vinit specializes in NLP, RAG, LLMs, and predictive analytics, with a focus on scalable, production-ready ML solutions.
